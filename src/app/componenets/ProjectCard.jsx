...
const ProjectCard = ({imgUrl, title, description, link1, link2, hasSource}) => {
  return (
    <div>
        ...
        style={{background: `url(${imgUrl})`, backgroundSize: "cover"}}>
            <div className='overlay flex items-center justify-center absolute top-0 left-0 w-full h-full bg-[#121212] opacity-0 group-hover:flex group-hover:opacity-80 transition-all duration-500'>
              {hasSource ? <Link href={link1} className='h-14 w-14 mr-4 border-2 relative rounded-full border-[#b3b3b3] hover:border-white group/link'>
